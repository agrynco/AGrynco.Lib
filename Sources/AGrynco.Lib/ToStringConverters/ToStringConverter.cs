...
namespace AGrynco.Lib.ToStringConverters
{
    public class ToStringConverter : IParamValueToStringConverter
    {
        ...
        public static string ConvertClass(object obj)
        {
            ...
            Dictionary<object, object> alreadyToStringConverted = new Dictionary<object, object>();
        ...
        private static PropertyInfo[] GetPropertiesToBeConverted(Type type)
        {
            ...
            return propertyInfos.Where(x => x.GetCustomAttributes(typeof(IgnoreConvertToStringAttribute), false).Length == 0).ToArray();
        }
        ...
        private static string ConvertClass(object obj, Dictionary<object, object> alreadyToStringConverted)
        {
            if (!alreadyToStringConverted.ContainsKey(obj))
            {
                ...
                PropertyInfo[] propertuesToBeConverted = GetPropertiesToBeConverted(obj.GetType());
        ...
        {
            return (propertyValue != null) && (!propertyValue.GetType().IsValueType) && (IsNotString(propertyValue.GetType()));
        }
        ...
        private static void ProcessValue(string propertyName, object propertyValue, StringBuilder result, Dictionary<object, object> alreadyToStringConverted)
        {
            List<string> valuesForFormattedString = new List<string>();
